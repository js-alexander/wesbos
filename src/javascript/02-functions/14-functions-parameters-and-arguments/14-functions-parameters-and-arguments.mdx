...
What happens in this function is first it looks inside of its own function scope, and it will look for a variable `firstName` that has been passed in. If it's not there what it will start to do is go up to a higher level of scope and look there.
